...
from lesQuiromanciers.model.instagram.InstagramClassification import InstagramClassification
import pandas as pd
import csv
import os
...
if __name__ == "__main__":
    ...
    instaData = InstagramFactory(["marty_the_cockerdale", "lecoindespatissiers", "cataniafoodprn", "guatemala_magica", "justinmin"],
